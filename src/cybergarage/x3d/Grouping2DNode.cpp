...
SFVec2f *Grouping2DNode::getBoundingBoxSizeField()
{
...
void Grouping2DNode::getBoundingBoxSize(float value[]) 
{
...
SFVec2f *Grouping2DNode::getBoundingBoxCenterField()
{
	if (isInstanceNode() == false)
...
void Grouping2DNode::getBoundingBoxCenter(float value[]) 
{
...
Grouping2DNode *Grouping2DNode::next() 
{
/*
...
Grouping2DNode *Grouping2DNode::nextTraversal() 
{
/*
