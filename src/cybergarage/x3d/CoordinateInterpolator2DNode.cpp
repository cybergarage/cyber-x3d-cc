...
#include <cybergarage/x3d/CoordinateInterpolator2DNode.h>
...
MFVec2f *CoordinateInterpolator2DNode::getKeyValueField()
{
...
int CoordinateInterpolator2DNode::getNKeyValues() 
{
	return getKeyValueField()->getSize();
}
	
void CoordinateInterpolator2DNode::getKeyValue(int index, float vector[]) 
{
...
SFVec2f *CoordinateInterpolator2DNode::getValueField()
{
	if (isInstanceNode() == false)
		return valueField;
...
void CoordinateInterpolator2DNode::getValue(float vector[]) 
{
...
bool CoordinateInterpolator2DNode::isChildNodeType(Node *node)
{
	return false;
}
...
void CoordinateInterpolator2DNode::outputContext(std::ostream &printStream, char *indentString) 
{
}
...
CoordinateInterpolator2DNode *CoordinateInterpolator2DNode::next() 
{
	return (CoordinateInterpolator2DNode *)Node::next(getType());
}

CoordinateInterpolator2DNode *CoordinateInterpolator2DNode::nextTraversal() 
{
