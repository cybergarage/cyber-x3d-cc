...
void SFVec3d::getValue(double value[]) 
{
	value[0] = mValue[0];
	value[1] = mValue[1];
	value[2] = mValue[2];
...
void SFVec3d::setValue(double value[]) 
{
	mValue[0] = value[0];
	mValue[1] = value[1];
	mValue[2] = value[2];
...
void SFVec3d::translate(double value[]) 
{
	add(value);
}
...
void SFVec3d::scale(double value[3]) 
{
...
void SFVec3d::rotate(double value[3]) 
{
...
char *SFVec3d::getValue(char *buffer, int bufferLen) 
{
...
bool SFVec3d::equals(Field *field) 
{
...
bool SFVec3d::equals(double value[3]) 
{
	SFVec3d vector(value);
	return equals(&vector);
}

bool SFVec3d::equals(double x, double y, double z) 
{
...
std::ostream& CyberX3D::operator<<(std::ostream &s, SFVec3d &vector) 
{
