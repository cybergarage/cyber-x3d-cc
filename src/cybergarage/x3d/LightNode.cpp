...
SFFloat *LightNode::getAmbientIntensityField()
{
...
float LightNode::getAmbientIntensity() 
{
...
void LightNode::getDiffuseColor(float value[]) 
{
	getColor(value);
...
void LightNode::getAmbientColor(float value[]) 
{
	getColor(value);
	float	intensity = getIntensity();
