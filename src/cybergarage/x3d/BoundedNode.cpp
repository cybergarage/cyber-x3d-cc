...
SFVec3f *BoundedNode::getBoundingBoxSizeField()
{
...
void BoundedNode::getBoundingBoxSize(float value[]) 
{
...
SFVec3f *BoundedNode::getBoundingBoxCenterField()
{
	if (isInstanceNode() == false)
...
void BoundedNode::getBoundingBoxCenter(float value[]) 
{
