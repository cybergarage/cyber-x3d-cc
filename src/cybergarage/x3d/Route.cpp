...
void Route::output(std::ostream& printStream) 
{
...
void Route::outputXML(std::ostream& printStream) 
{
	if (!getEventOutNode() && !getEventOutField() && !getEventInNode() && !getEventInField())
		return;

	printStream << "<ROUTE ";
	printStream << "fromNode=\"" << getEventOutNode()->getName() << "\" fromField=\"" << getEventOutField()->getName() << "\" ";
	printStream << "toNode=\""  << getEventInNode()->getName() << "\" toField=\"" << getEventInField()->getName() << "\"";
	printStream << "/>" << std::endl; 
}
