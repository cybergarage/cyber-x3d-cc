...
SFVec2f *Bounded2DNode::getBoundingBoxSizeField()
{
...
void Bounded2DNode::getBoundingBoxSize(float value[]) 
{
...
SFVec2f *Bounded2DNode::getBoundingBoxCenterField()
{
	if (isInstanceNode() == false)
...
void Bounded2DNode::getBoundingBoxCenter(float value[]) 
{
