...
SFNode *ShapeNode::getAppearanceField() 
{
...
SFNode *ShapeNode::getGeometryField() 
{
	if (isInstanceNode() == false)
		return geomField;
...
Geometry3DNode *ShapeNode::getGeometry3D() 
{
...
void ShapeNode::outputContext(std::ostream &printStream, char *indentString) 
{
