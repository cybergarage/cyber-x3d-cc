...
SFVec3f *BoundedGroupingNode::getBoundingBoxSizeField()
{
...
void BoundedGroupingNode::getBoundingBoxSize(float value[]) 
{
...
SFVec3f *BoundedGroupingNode::getBoundingBoxCenterField()
{
	if (isInstanceNode() == false)
...
void BoundedGroupingNode::getBoundingBoxCenter(float value[]) 
{
