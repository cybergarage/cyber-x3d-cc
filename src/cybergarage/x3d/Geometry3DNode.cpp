...
SFVec3f *Geometry3DNode::getBoundingBoxSizeField()
{
...
void Geometry3DNode::getBoundingBoxSize(float value[]) 
{
...
SFVec3f *Geometry3DNode::getBoundingBoxCenterField()
{
	if (isInstanceNode() == false)
...
void Geometry3DNode::getBoundingBoxCenter(float value[]) 
{
