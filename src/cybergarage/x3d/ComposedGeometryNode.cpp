...
SFNode *ComposedGeometryNode::getColorField() 
{
...
SFNode *ComposedGeometryNode::getCoordField() 
{
	if (isInstanceNode() == false)
		return coordField;
...
SFNode *ComposedGeometryNode::getNormalField() 
{
	if (isInstanceNode() == false)
		return normalField;
...
SFNode *ComposedGeometryNode::getTexCoordField() 
{
	if (isInstanceNode() == false)
...
SFBool *ComposedGeometryNode::getCCWField()
{
	if (isInstanceNode() == false)
		return ccwField;
...
bool ComposedGeometryNode::getCCW() 
{
...
SFBool *ComposedGeometryNode::getColorPerVertexField()
{
	if (isInstanceNode() == false)
...
bool ComposedGeometryNode::getColorPerVertex() 
{
...
SFBool *ComposedGeometryNode::getNormalPerVertexField()
{
	if (isInstanceNode() == false)
...
bool ComposedGeometryNode::getNormalPerVertex() 
{
...
SFBool *ComposedGeometryNode::getSolidField()
{
	if (isInstanceNode() == false)
		return solidField;
...
bool ComposedGeometryNode::getSolid() 
{
