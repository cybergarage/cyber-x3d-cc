...
void BoundingBox2D::getMinPosition(float pos[2])
{
	pos[0] = mMinPosition[0];
	pos[1] = mMinPosition[1];
}

void BoundingBox2D::getMaxPosition(float pos[2])
{
...
void BoundingBox2D::getCenter(float center[2])
{
	if (0 < getNPoints()) {
...
void BoundingBox2D::getSize(float size[2])
{
	if (0 < getNPoints()) {
