...
SFVec2f *BoundedGrouping2DNode::getBoundingBoxSizeField()
{
...
void BoundedGrouping2DNode::getBoundingBoxSize(float value[]) 
{
...
SFVec2f *BoundedGrouping2DNode::getBoundingBoxCenterField()
{
	if (isInstanceNode() == false)
...
void BoundedGrouping2DNode::getBoundingBoxCenter(float value[]) 
{
