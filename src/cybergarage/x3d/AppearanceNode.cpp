...
SFNode *AppearanceNode::getMaterialField() 
{
...
SFNode *AppearanceNode::getTextureField() 
{
	if (isInstanceNode() == false)
		return textureField;
...
SFNode *AppearanceNode::getTextureTransformField() 
{
	if (isInstanceNode() == false)
...
SFNode *AppearanceNode::getLinePropertiesField() 
{
	if (isInstanceNode() == false)
...
SFNode *AppearanceNode::getFillPropertiesField() 
{
	if (isInstanceNode() == false)
...
void AppearanceNode::outputContext(std::ostream &printStream, char *indentString) 
{
