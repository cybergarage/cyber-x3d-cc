...
#include <cybergarage/x3d/PositionInterpolator2DNode.h>
...
MFVec2f *PositionInterpolator2DNode::getKeyValueField()
{
...
int PositionInterpolator2DNode::getNKeyValues() 
{
	return getKeyValueField()->getSize();
}
	
void PositionInterpolator2DNode::getKeyValue(int index, float vector[]) 
{
...
SFVec2f *PositionInterpolator2DNode::getValueField()
{
	if (isInstanceNode() == false)
		return valueField;
...
void PositionInterpolator2DNode::getValue(float vector[]) 
{
...
bool PositionInterpolator2DNode::isChildNodeType(Node *node)
{
	return false;
}
...
void PositionInterpolator2DNode::outputContext(std::ostream &printStream, char *indentString) 
{
}
...
PositionInterpolator2DNode *PositionInterpolator2DNode::next() 
{
	return (PositionInterpolator2DNode *)Node::next(getType());
}

PositionInterpolator2DNode *PositionInterpolator2DNode::nextTraversal() 
{
