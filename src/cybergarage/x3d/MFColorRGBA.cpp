...
#include <cybergarage/x3d/MFColorRGBA.h>
...
void MFColorRGBA::get1Value(int index, float value[]) 
{
...
void MFColorRGBA::outputContext(std::ostream& printStream, char *indentString) 
{
	float value[3];
